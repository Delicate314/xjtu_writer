<template>
    <div class="table-wrapper">
      ...
      >
        <el-table-column fixed sortable prop="novel_id" label="小说id" width="120"></el-table-column>
        <el-table-column sortable prop="user_id" label="用户id" width="120"></el-table-column>
        <el-table-column sortable prop="novel_title" label="小说标题" width="150"></el-table-column>
        ...
        <el-table-column sortable prop="novel_viewcount" label="浏览量" width="100"></el-table-column>
        <el-table-column fixed="right" label="操作" width="200">
          <template slot-scope="scope">
            ...
            >
              <el-button slot="reference" type="danger" size="small" class="button">删除</el-button>
            </el-popconfirm>
            <el-button
              class="button"
