        ...
        <el-container>
          <el-header>
            <el-row :gutter="20">
                ...
                <el-col :span="4" :offset="14"><div class="right-content bg-purple">
...
.user-content {
    display: flex;
    text-align: right;
    align-items: center; /* 使文字和图片的中点水平对齐 */
}

.user-img {
    margin-left: 20px; /* 调整图片和文字之间的距离 */
    border-radius: 50%; /* 使用圆角 */
    width: 40px; /* 固定宽度，保证圆角效果 */
    height: 40px; /* 固定高度，保证圆角效果 */
}
...
.custom-img {
  width: 40px; /* 图片宽度与文字大小一致 */
  height: 40px; /* 图片高度与文字大小一致 */
